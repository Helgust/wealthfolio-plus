...
> **2026-09-25: фазы 0–3 закрыты.** Итоги — в `docs/wealthfolio-plan.md`, разделы «Итоги фазы 0»,
> «Итоги фазы 1», «Ход фазы 2» и «Ход фазы 3».
> Следующая задача — фаза 4 «Monte Carlo, бэктест и Progress»; её срезы и решения — раздел
> «Фаза 4» плана.
