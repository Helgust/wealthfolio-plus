...
> **2026-09-25: фазы 0–2 закрыты.** Итоги — в `docs/wealthfolio-plan.md`, разделы «Итоги фазы 0»,
> «Итоги фазы 1» и «Ход фазы 2». Следующая задача — фаза 3 «Планы в духе ProjectionLab», по срезам
> из раздела «Срезы фазы 3».
