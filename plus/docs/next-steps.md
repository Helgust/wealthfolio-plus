...
> **2026-09-25: фазы 0 и 1 закрыты.** Итоги — в `docs/wealthfolio-plan.md`, разделы «Итоги фазы 0»
> и «Итоги фазы 1». Следующая задача — фаза 2 «Реальный портфель по-испански».
